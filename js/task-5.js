...
//    * Конструктор получает объект настроек. Добавь свойства будущего экземпляра класса:
...
//    * Добавь код, чтобы завести автомобиль. Записывает в свойство isOn значение true
    turnOn() {
        return this._isOn = true;
    }

    // * Добавь код, чтобы заглушить автомобиль
    // * Записывает в свойство isOn значение false и сбрасывает текущую скорость в 0
    turnOff() {
        this._isOn = false;
        this._speed = 0;
